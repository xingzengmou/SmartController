package com.only.work.room.scenecontrol;
...
//		}
	...
	public void setSinglePathId(int  i) {
		cmd[14] =  (byte)i;
	}
	
	public void setSinglePathStatus(int code, boolean status) {
		cmd[22] = (byte) code;
		cmd[23] = (byte) (status ? 1 : 0);
	}
	
	public void setSingleCode(int code) {
		cmd[22] = (byte) code;
	}
